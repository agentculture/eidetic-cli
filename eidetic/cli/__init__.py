...
from eidetic import __version__
from eidetic.cli._errors import EXIT_USER_ERROR, CliError
from eidetic.cli._output import emit_error

_ISSUES_URL = "https://github.com/agentculture/eidetic-cli/issues"
...
def _build_parser() -> argparse.ArgumentParser:
    from eidetic.cli._commands import cli as _cli_group
    ...
    from eidetic.cli._commands import sweep as _sweep_cmd
    from eidetic.cli._commands import whoami as _whoami_cmd

    parser = _CliArgumentParser(
        prog="eidetic-cli",
        description="eidetic-cli — a clonable template for AgentCulture mesh agents.",
    )
    parser.add_argument(
        "--version",
        action="version",
