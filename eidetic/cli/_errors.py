...
Every failure inside eidetic-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`eidetic.cli._output`,
...
# Exit-code policy. Documented in ``eidetic-cli learn`` output.
# 0      = success
